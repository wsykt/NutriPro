...
# Prompt 模板已拆至 prompts/ 包（数据与逻辑分离，避免大模块膨胀）
...
class ModeRouter:
    ...
    def stream_qa(self, high_performance: bool = False, **kwargs) -> Any:
        ...
        # func_type 已由 stream_qa 显式指定为 "qa"，需从 kwargs 中剔除，
        # 否则 _build_prompt_params("qa", "", **kwargs) 会因 func_type 双重传入抛 TypeError
        kwargs.pop("func_type", None)
