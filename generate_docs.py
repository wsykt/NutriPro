...
#### 现有数据统计
- **总文档数**: 608 篇
- **来源分布**: PubMed (87.5%), Europe-PMC (6.9%), 官方指南 (5.6%)
...
#### 薄弱领域
1. ⚠️ **健身人群**: 仅69篇（最少）
2. ⚠️ **特定疾病**: 痛风、骨质疏松、脂肪肝
3. ⚠️ **食物数据库**: 缺乏系统的食物成分数据
4. ⚠️ **实操食谱**: 缺少标准化的健康食谱库
5. ⚠️ **心理学营养**: 情绪性进食、饮食行为矫正
...
#### 第二阶段 (短期规划)
- [ ] 爬取中国食物营养成分数据库（nlc.chinanutri.cn）
...
| 文件 | 路径 | 说明 |
|------|------|------|
| 知识库数据 | ai_service/knowledge_base/full_knowledge_base.json | 608篇结构化文档 |
